...
const file_xai_api_v1_image_proto_rawDesc = "" +
	...
	"\x05Image\x12H\n" +
	"\rGenerateImage\x12\x1d.xai_api.GenerateImageRequest\x1a\x16.xai_api.ImageResponse\"\x00B~\n" +
	"\vcom.xai_apiB\n" +
	"ImageProtoP\x01Z+github.com/modelrelay/xai-go/gen/xai/api/v1\xa2\x02\x03XXX\xaa\x02\x06XaiApi\xca\x02\x06XaiApi\xe2\x02\x12XaiApi\\GPBMetadata\xea\x02\x06XaiApib\x06proto3"

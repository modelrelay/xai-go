...
const (
	...
	Chat_CompactContext_FullMethodName          = "/xai_api.Chat/CompactContext"
)
...
type ChatClient interface {
	...
	CompactContext(ctx context.Context, in *CompactContextRequest, opts ...grpc.CallOption) (*CompactContextResponse, error)
}
...
func (c *chatClient) CompactContext(ctx context.Context, in *CompactContextRequest, opts ...grpc.CallOption) (*CompactContextResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompactContextResponse)
	err := c.cc.Invoke(ctx, Chat_CompactContext_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServer interface {
	...
	// set of items (with an opaque compaction blob) suitable for use as
	// the input to the next request.
	CompactContext(context.Context, *CompactContextRequest) (*CompactContextResponse, error)
...
func (UnimplementedChatServer) CompactContext(context.Context, *CompactContextRequest) (*CompactContextResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CompactContext not implemented")
}
...
func _Chat_CompactContext_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompactContextRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).CompactContext(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_CompactContext_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).CompactContext(ctx, req.(*CompactContextRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Chat_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Chat_CompactContext_Handler,
		},
	},
